...
export const getVehicles       = (date, gateId = 0) =>
  api.get(`/vehicles?date=${date}&gateId=${gateId}`).then(r => r.data);
...
export const markVehicleOut    = (id, body = {}) =>
  api.patch(`/vehicles/${id}/out`, body).then(r => r.data);
