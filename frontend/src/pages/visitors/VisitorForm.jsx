...
import { ArrowLeft, Camera, LogOut, Save, UserCheck, ChevronDown, ChevronUp } from "lucide-react";
...
export default function VisitorForm() {
  ...
  const capture = () => {
    ...
    // Store as base64 — sent in VPhotoPath field to SP
  ...
  const onSave = async () => {
    ...
    setSaving(true);
    try {
      // photo sent as base64 string in photo field → backend puts in VPhotoPath
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                ...
                <input name="mobile" className={`form-input ${errors.mobile?"err":""}`}
                  value={form.mobile} onChange={onChange} placeholder="Mobile number"
                  inputMode="numeric"/>
                {errors.mobile && <div className="form-error">{errors.mobile}</div>}
              </div>
            </div>

            {/* ID Card — dropdown + number */}
            <div className="form-row">
              <div className="form-group">
