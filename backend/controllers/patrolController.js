...
exports.getLogs = async (req, res, next) => {
  try {
    ...
    const data    = await service.getPatrolLogs({ companyId, date, guardId });
...
exports.markCheckpoint = async (req, res, next) => {
  try {
    ...
    const result = await service.markCheckpoint({ companyId, gateId, guardId: userId, locationId, remarks });
